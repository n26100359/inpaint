...
class CGAN:
    ...
    def __init__(self, img_shape, lr=0.0005):
    ...
    def build_D(self, input_shape): # input whole image, output 0~1
        ...
        drop1 = Dropout(.4)(flat)
        dense1 = Dense(32, activation='relu')(drop1)
        
        drop2 = Dropout(.4)(dense1)
    ...
    def build_G(self, input_shape): # input left half, output right half
        ...
        bn3 = BatchNormalization()(flat)
        dense1 = Dense(32, activation='relu')(bn3)
        bn4 = BatchNormalization()(dense1)
        
        dense2 = Dense(32, activation='relu')(bn4)
        bn5 = BatchNormalization()(dense2)
        
        dense3 = Dense(8*4*30, activation='relu')(bn5)
    ...
    def train(self, tr_left, tr_right, batch_size=200, epochs=10000, train_D_iter=5, save_model_iter=100, save_path='./models/GAN/', use_fake2=True):
        
        assert tr_left.shape[0] == tr_right.shape[0]
        
        dir_name = f'GAN_batch{batch_size}_diter{train_D_iter}_fake2{use_fake2}'
...
#     cgan.train(xtrain, ytrain, batch_size=200, epochs=40000, train_D_iter=5, save_model_iter=200)
    ...
    cgan = CGAN((32,32,3), lr=0.0001)
    cgan.train(xtrain, ytrain, batch_size=200, epochs=20000, train_D_iter=1, save_model_iter=500, save_path='./models/GAN_cifar/')
